...
import com.sz.eggplantnovel.core.annotation.Key;
import com.sz.eggplantnovel.core.annotation.Lock;
...
import com.sz.eggplantnovel.dao.entity.*;
import com.sz.eggplantnovel.dao.mapper.BookChapterMapper;
import com.sz.eggplantnovel.dao.mapper.BookCommentMapper;
...
public class BookServiceImpl implements BookService {
    ...
    public RestResp<Long> getPreChapterId(Long chapterId) {
        ...
        queryWrapper.lt(DatabaseConsts.BookChapterTable.COLUMN_CHAPTER_NUM, chapterNum)
    ...
    public RestResp<Long> getNextChapterId(Long chapterId) {
        ...
        // 查询下一章信息并返回章节ID
        QueryWrapper<BookChapter> queryWrapper =new QueryWrapper<>();
        queryWrapper.gt(DatabaseConsts.BookChapterTable.COLUMN_CHAPTER_NUM, chapterNum)
